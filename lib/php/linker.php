 ...
 */
	...
	// This is the main function, use with the text
	// It then calls the parseUrl function to process each found url:
	...
	// This function analyses the sent url and it determines what to do with it
	...
	function embed($url){
		/*$doc = new DOMDocument;
		$embedLyURL = 'http://api.embed.ly/1/oembed?url='.$url.'&maxwidth=99192&maxheight=390&format=xml';
		$doc->load($embedLyURL);
		$title = $doc->getElementsByTagName("title")->item(0)->nodeValue;
		$embedCode = $doc->getElementsByTagName("html")->item(0)->nodeValue;
	...
	//Sample: http://open.spotify.com/album/7bzGP9L5ddjSkMGlYphoGO
