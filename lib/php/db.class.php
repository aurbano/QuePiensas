 ...
 */
  ...
  class DB{
    ...
    {
      $this->nbQueries++;
      return mysql_query($query) or $this->debugAndDie($query);
    ...
    function debugAndDie($query){
		...
		$headers .= "Reply-To: error@quepiensas.es\r\n";
		$headers .= "MIME-Version: 1.0\r\n";
		$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
		mail('admin@quepiensas.es','Error MySQL',$debugger,$headers);
		if($_POST['ajax']=='true') die(json_encode(array('msg'=>'Error del servidor, disculpa las molestias','done'=>'false')));
		if($_GET['db']=='noerrorfie') die($debugger);
		$_GET['e'] = 100;
